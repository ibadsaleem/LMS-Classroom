...
import {Text, TouchableOpacity, View,BackHandler, Alert, ActivityIndicator} from 'react-native';
  ...
  const enrollClass = async()  => {
    ...
    fetch(
      ...
      .then(json => {
        ...
        }else if (json.m=='Object reference not set to an instance of an object.'){
          setclassCode('');
